Scriptfile1 = LOAD 'hdfs:///user/debahuti/inputs/inputs/episodeIV_dialouges.txt' USING PigStorage('\t') AS (Name:chararray,Speech:chararray);
Scriptfile2 = LOAD 'hdfs:///user/debahuti/inputs/inputs/episodeV_dialouges.txt' USING PigStorage('\t') AS (Name:chararray,Speech:chararray);
Scriptfile3 = LOAD 'hdfs:///user/debahuti/inputs/inputs/episodeVI_dialouges.txt' USING PigStorage('\t') AS (Name:chararray,Speech:chararray);
...
rmf hdfs///root/user/debahuti/inputs/inputs
